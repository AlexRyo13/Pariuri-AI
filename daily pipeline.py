        ...
        if event.get("home_team") == home_team and event.get("away_team") == away_team:
            ...
            for bookmaker in event.get("bookmakers", []):
                for market in bookmaker.get("markets", []):
                    ...
                    # Nota: piata "btts" (GG/NG) nu e disponibila pe planul gratuit
                    # The Odds API. Modelul tot calculeaza probabilitatea GG/NG,
                    # doar ca fara cota de comparat - va aparea ca "fara cota".
            return best
    return None
